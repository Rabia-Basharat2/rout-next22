...
const page = () => {
  return (
    <div>Contact us<figure className="md:flex bg-slate-100 rounded-xl p-8 md:p-0 dark:bg-slate-800">
    ...
    <div className="pt-6 md:p-8 text-center md:text-left space-y-4">
      ...
      <figcaption className="font-medium">Phone Number: 0310-0664728
